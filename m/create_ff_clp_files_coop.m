%% create_ff_clp_files_coop.m
basic_heuristics = {'mutation1bit'};
KI_heuristics = {'crossover1pointCoop','improveOrbitCoop','removeInterfCoop','addSynergyCoop','removeSuperfluousCoop','addRandomToSmallSatCoop','removeRandomFromLoadedSatCoop'};
n = length(KI_heuristics);
root = './clp/search_heuristic_rules_smap_';
look_at = cellfun(@bi2de,{[1 1 1 1 1 1 1]},'UniformOutput',false);
% look_at = 1:2^n-1;
