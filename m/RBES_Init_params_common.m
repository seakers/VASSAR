...
if isempty(params) || nargin > 0
    ...
    params.mission_analysis_database_xls    = '..\xls\Mission Analysis Database.xlsx';
%     params.data_continuity_xls              = '..\xls\Data Continuity Requirements.xlsx';
    params.data_continuity_xls              = '..\xls\Data Continuity Requirements - corrected.xlsx';
    params.synergy_rules_xls                = '..\xls\Synergy Rules.xlsx';
    params.precursor_missions_xls_path      = '..\xls\CEOS timelines 1993-2024\';
...
%     params.timestep     = (2/12);% 1 month
    params.timestep = 1/12;
    params.startdate = 1997;
    params.enddate = 2020;
